...
from dagster.core.snap.dep_snapshot import DependencyStructureSnapshotIndex
...
def test_basic_comp_solid_definition():
    ...
    index = DependencyStructureSnapshotIndex(comp_solid_meta.dep_structure_snapshot)
